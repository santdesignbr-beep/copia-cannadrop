...
class DoacoesWidget extends StatefulWidget {
  const DoacoesWidget({super.key});

  @override
  State<DoacoesWidget> createState() => _DoacoesWidgetState();
}
...
class _DoacoesWidgetState extends State<DoacoesWidget> {
  ...
  void initState() {
    ...
    _model.textFieldMask = MaskTextInputFormatter(mask: 'R\$ #,###,##');
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 30.0, 0.0, 30.0),
                              child: Text(
                                '🤝❤ Juntos, fazemos a diferença na vida de muitos! Nossas ações aliviaram o sono de crianças, idosos e todos que precisam. O CBD é esperança e qualidade de vida para todos. ✨ Seja a luz que ilumina o caminho daqueles que precisam. \n\n💪✨ Faça a diferença, agora! 🌟 \n\n#DoeEsperança #MudeVidas ',
