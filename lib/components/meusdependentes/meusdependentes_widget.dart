...
import 'meusdependentes_model.dart';
export 'meusdependentes_model.dart';

class MeusdependentesWidget extends StatefulWidget {
  const MeusdependentesWidget({super.key});

  static String routeName = 'meusdependentes';
  static String routePath = 'meusdependentes';

  @override
  State<MeusdependentesWidget> createState() => _MeusdependentesWidgetState();
}

class _MeusdependentesWidgetState extends State<MeusdependentesWidget>
    with TickerProviderStateMixin {
  late MeusdependentesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeusdependentesModel());
                    ...
                    child: Material(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            context.pushNamed(CadastromenorWidget.routeName);
                          },
                          child: Row(
                            mainAxisSize: MainAxisSize.max,
                        ...
                        children: [
                          Expanded(
                            child: Padding(
                              ...
                              child: AuthUserStreamWidget(
                                builder: (context) =>
                                    StreamBuilder<List<MenorRecord>>(
                                  stream: queryMenorRecord(
                                    queryBuilder: (menorRecord) => menorRecord
                                        .where(
                                          'nomeresp',
                                  ...
                                  builder: (context, snapshot) {
                                    ...
                                    List<MenorRecord> listViewMenorRecordList =
                                        snapshot.data!;
                                    ...
                                    return ListView.builder(
                                      ...
                                      itemCount: listViewMenorRecordList.length,
                                      itemBuilder: (context, listViewIndex) {
                                        final listViewMenorRecord =
                                            listViewMenorRecordList[
                                                listViewIndex];
                                        return Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                                            ...
                                                                            children: [
                                                                              Padding(
                                                                                ...
                                                                                child: InkWell(
                                                                                  ...
                                                                                  onTap: () async {
                                                                                    context.pushNamed(
                                                                                      DadospessoaismenorWidget.routeName,
                                                                                      queryParameters: {
                                                                                        'menoruser': serializeParam(
                                                                                          listViewMenorRecord.reference,
                                                                                          ParamType.DocumentReference,
                                                                                        ),
                                                                                      }.withoutNulls,
                                                                                    );
                                                                        ...
                                                                        children: [
                                                                          Align(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              dateTimeFormat(
                                                                                "d/M/yyyy  h:mm a",
                                                                                listViewMenorRecord.createdTime!,
