                        ...
                        child: Container(
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'Estamos aqui para ouvir você! \n\nSe você tem perguntas, sugestões, ou precisa de suporte, por favor, não hesite em entrar em contato conosco. Sua opinião é valiosa e queremos garantir que sua experiência com o Canna Drop App seja a melhor possível.\n\nSe preferir, você também pode entrar em contato pelos seguintes meios:',
                                ...
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 15.0, 0.0, 0.0),
                                  child: Text(
                                    'Estamos disponíveis de segunda a sexta-feira, das 9h às 18h, para atendê-lo da melhor forma possível.\n\nObrigado por escolher o aplicativo Canna Drop. Estamos ansiosos para ouvir você!',
                                    textAlign: TextAlign.justify,
                                    style: FlutterFlowTheme.of(context)
                                        .bodyMedium
                                        .override(
