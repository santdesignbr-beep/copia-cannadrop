...
class LoginCadastroWidget extends StatefulWidget {
  ...
  static String routeName = 'Login-cadastro';
...
class _LoginCadastroWidgetState extends State<LoginCadastroWidget>
  ...
  void initState() {
    ...
    _model.emailcriarTextController ??= TextEditingController();
    _model.emailcriarFocusNode ??= FocusNode();

    _model.senhacriarTextController ??= TextEditingController();
    _model.senhacriarFocusNode ??= FocusNode();

    _model.passwordconfirmarTextController ??= TextEditingController();
                                                    ...
                                                    children: [
                                                            ...
                                                            child:
                                                              ...
                                                              keyboardType:
                                                                  TextInputType
                                                                      .emailAddress,
                                                              validator: _model
                                                                  .emailcriarTextControllerValidator
                                                                  .asValidator(
                                                                      context),
                                                            ),
                                                          ),
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: TextFormField(
                                                            ...
                                                            validator: _model
                                                                .senhacriarTextControllerValidator
                                                                .asValidator(
                                                                    context),
                                                          ),
                                                        ),
                                                      ...
                                                      Padding(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: TextFormField(
                                                            controller: _model
                                                                .passwordconfirmarTextController,
                                                            focusNode: _model
                                                                .passwordconfirmarFocusNode,
                                                            autofocus: true,
                                                            autofillHints: [
                                                              AutofillHints
                                                                  .password
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: FFButtonWidget(
                                                            onPressed:
                                                              ...
                                                              safeSetState(
                                                                  () {});
                                                              _model.pinverificado =
                                                                  await EmailNotificationsCall
                                                                      .call(
                                                                name:
                                                                  ...
                                                                  if (valueOrDefault(
                                                                    ...
                                                                    if (valueOrDefault(currentUserDocument?.assinatura, '') ==
                                                                      ...
                                                                      if (valueOrDefault(currentUserDocument?.regiao, '') ==
                                                                              null ||
                                                                          valueOrDefault(currentUserDocument?.regiao, '') ==
                                                                              '') {
                                                                        context.pushNamedAuth(
