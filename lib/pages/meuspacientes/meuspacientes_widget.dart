...
import 'meuspacientes_model.dart';
export 'meuspacientes_model.dart';

class MeuspacientesWidget extends StatefulWidget {
  const MeuspacientesWidget({super.key});

  static String routeName = 'meuspacientes';
  static String routePath = 'meuspacientes';

  @override
  State<MeuspacientesWidget> createState() => _MeuspacientesWidgetState();
}

class _MeuspacientesWidgetState extends State<MeuspacientesWidget>
    with TickerProviderStateMixin {
  late MeuspacientesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeuspacientesModel());
                                                                  ...
                                                                  child: Text(
                                                                    ...
                                                                    style: FlutterFlowTheme.of(
                                                                        ...
                                                                        .override(
                                                                          ...
                                                                          color:
                                                                              FlutterFlowTheme.of(context).noaktive,
                                                                          fontSize:
                                                                              10.0,
                                                                          letterSpacing:
                                                                              0.0,
