...
import 'buscar_user_model.dart';
export 'buscar_user_model.dart';

class BuscarUserWidget extends StatefulWidget {
  const BuscarUserWidget({super.key});

  static String routeName = 'BuscarUser';
  static String routePath = 'buscarUser';

  @override
  State<BuscarUserWidget> createState() => _BuscarUserWidgetState();
}

class _BuscarUserWidgetState extends State<BuscarUserWidget> {
  late BuscarUserModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuscarUserModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UserRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UserRecord> buscarUserUserRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final buscarUserUserRecord = buscarUserUserRecordList.isNotEmpty
            ? buscarUserUserRecordList.first
            : null;
                                                                                      ...
                                                                                      child: Column(
                                                                                        ...
                                                                                        children: [
                                                                                          Row(
                                                                                            ...
                                                                                            children: [
                                                                                              Text(
                                                                                                onSearchUserRecord.displayName,
                                ...
                                Padding(
                                  ...
                                  child: AuthUserStreamWidget(
                                    builder: (context) =>
                                      ...
                                      stream: queryUserRecord(
                                        queryBuilder: (userRecord) =>
                                            userRecord.whereArrayContainsAny(
                                                'lista_meuspacientes',
                                                (currentUserDocument
                                                        ?.listaMeuspacientes
                                                        .toList() ??
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<UserRecord>
                                            listViewUserRecordList = snapshot
                                                .data!
                                                .where((u) =>
