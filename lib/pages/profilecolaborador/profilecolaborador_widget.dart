...
import 'profilecolaborador_model.dart';
export 'profilecolaborador_model.dart';

class ProfilecolaboradorWidget extends StatefulWidget {
  const ProfilecolaboradorWidget({super.key});

  static String routeName = 'profilecolaborador';
  static String routePath = 'profilecolaborador';

  @override
  State<ProfilecolaboradorWidget> createState() =>
      _ProfilecolaboradorWidgetState();
}

class _ProfilecolaboradorWidgetState extends State<ProfilecolaboradorWidget>
    with TickerProviderStateMixin {
  late ProfilecolaboradorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfilecolaboradorModel());
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Align(
                                    alignment:
                                        AlignmentDirectional(-0.04, 1.16),
                                    child: AuthUserStreamWidget(
                                      builder: (context) => Text(
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Padding(
                                                                                    padding: EdgeInsetsDirectional.fromSTEB(6.0, 4.0, 0.0, 4.0),
                                                                                    child: Text(
                                                                                      listViewUserRecord.horario,
                                                                                      textAlign: TextAlign.center,
                                                                                      style: FlutterFlowTheme.of(context).headlineSmall.override(
                                                                                            font: GoogleFonts.openSans(
                                                                                              fontWeight: FontWeight.bold,
