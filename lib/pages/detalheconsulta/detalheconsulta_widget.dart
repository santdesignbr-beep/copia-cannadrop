...
import 'detalheconsulta_model.dart';
export 'detalheconsulta_model.dart';

class DetalheconsultaWidget extends StatefulWidget {
  const DetalheconsultaWidget({
    super.key,
    required this.consultadetalhe,
  });

  final DocumentReference? consultadetalhe;

  static String routeName = 'detalheconsulta';
  static String routePath = 'detalheconsulta';

  @override
  State<DetalheconsultaWidget> createState() => _DetalheconsultaWidgetState();
}

class _DetalheconsultaWidgetState extends State<DetalheconsultaWidget>
    with TickerProviderStateMixin {
  late DetalheconsultaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalheconsultaModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ConsultaRecord>(
      stream: ConsultaRecord.getDocument(widget.consultadetalhe!),
      builder: (context, snapshot) {
        ...
        final detalheconsultaConsultaRecord = snapshot.data!;
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Align(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              detalheconsultaConsultaRecord.prescricao,
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Align(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            detalheconsultaConsultaRecord.anvisa,
                                                                            style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                  font: GoogleFonts.openSans(
                                                                                    fontWeight: FontWeight.bold,
                                                                                    fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                      ...
                                                      child: ClipRRect(
                                                        borderRadius:
                                                            BorderRadius
                                                                .circular(8.0),
                                                        child: Image.asset(
                                                          'assets/images/boto_rede_cannadrop_#F40163_maior.png',
                                                          width: 300.0,
                                                          height: 150.0,
                                                          fit: BoxFit.cover,
                                                        ),
                                                            ...
                                                            builder:
                                                              ...
                                                              return AlertDialog(
                                                                title: Text(
                                                                    'Concluido.'),
                                                                content: Text(
                                                                    'Sua consulta foi concluido com sucesso.'),
                                                                actions: [
                                                                  TextButton(
                                                                    onPressed: () =>
                                                                        Navigator.pop(
