...
import 'perfilpaciente_model.dart';
export 'perfilpaciente_model.dart';
...
class PerfilpacienteWidget extends StatefulWidget {
  ...
  final DocumentReference? perfilpaciente;
...
class _PerfilpacienteWidgetState extends State<PerfilpacienteWidget>
  ...
  void initState() {
    ...
    _model.documentoController = TabController(
      vsync: this,
      length: 3,
      initialIndex: 0,
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UserRecord>(
      stream: UserRecord.getDocument(widget.perfilpaciente!),
      builder: (context, snapshot) {
        ...
        final perfilpacienteUserRecord = snapshot.data!;
                                                              ...
                                                              child:
                                                                ...
                                                                builder: (context) =>
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    final iconRedeCannadropRecord = iconRedeCannadropRecordList
                                                                            .isNotEmpty
                                                                        ? iconRedeCannadropRecordList
                                                                            .first
                                                                        : null;
                                                                    ...
                                                                    return InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        context.pushNamed(
                                                                            ComoestoumesentindoWidget.routeName);
                                                                      },
                                                                      child:
                                                                          Icon(
                                                                        Icons
                                                                        ...
                                                                        Align(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Text(
                                                                                perfilpacienteUserRecord.regiao,
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child: StreamBuilder<
                                                                      ...
                                                                      stream:
                                                                        ...
                                                                        queryBuilder: (agendamentoRecord) => agendamentoRecord
                                                                            .where(
                                                                              'Paciente',
                                                                              isEqualTo: perfilpacienteUserRecord.displayName,
                                                                            )
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return ListView
                                                                          ...
                                                                          scrollDirection:
                                                                              Axis.vertical,
                                                                          itemCount:
                                                                              listViewAgendamentoRecordList.length,
                                                                          itemBuilder:
                                                                              (context, listViewIndex) {
                                                                            final listViewAgendamentoRecord =
                                                                                listViewAgendamentoRecordList[listViewIndex];
                                                                            return Padding(
                                                      ...
                                                      Align(
                                                        ...
                                                        child: Padding(
                                                          ...
                                                          child: StreamBuilder<
                                                            ...
                                                            stream:
                                                                queryConsultaRecord(
                                                              queryBuilder: (consultaRecord) =>
                                                                  consultaRecord
                                                                      .where(
                                                                        'paciente',
                                                                        isEqualTo:
                                                                            perfilpacienteUserRecord.displayName,
                                                                      )
                                                                      .orderBy(
                                                                          'created_time',
                                                                          descending:
