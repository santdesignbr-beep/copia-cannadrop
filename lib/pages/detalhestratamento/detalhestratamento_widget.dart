...
import 'detalhestratamento_model.dart';
export 'detalhestratamento_model.dart';

class DetalhestratamentoWidget extends StatefulWidget {
  const DetalhestratamentoWidget({
    super.key,
    required this.tratamento,
  });

  final DocumentReference? tratamento;

  static String routeName = 'detalhestratamento';
  static String routePath = 'detalhestratamento';

  @override
  State<DetalhestratamentoWidget> createState() =>
      _DetalhestratamentoWidgetState();
}

class _DetalhestratamentoWidgetState extends State<DetalhestratamentoWidget>
    with TickerProviderStateMixin {
  late DetalhestratamentoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalhestratamentoModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TratamentoRecord>(
      stream: TratamentoRecord.getDocument(widget!.tratamento!),
      builder: (context, snapshot) {
        ...
        final detalhestratamentoTratamentoRecord = snapshot.data!;
                                                ...
                                                Padding(
                                                  padding: EdgeInsetsDirectional
                                                      .fromSTEB(
                                                          0.0, 4.0, 0.0, 4.0),
                                                  child: Text(
                                                    detalhestratamentoTratamentoRecord
                                                        .paciente,
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .headlineSmall
