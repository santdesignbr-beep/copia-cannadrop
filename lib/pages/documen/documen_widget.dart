...
import '/components/newdocument_widget.dart';
...
import 'documen_model.dart';
export 'documen_model.dart';

class DocumenWidget extends StatefulWidget {
  const DocumenWidget({
    super.key,
    this.docs,
  ...
  final DocumentosRecord? docs;
  final DocumentReference? docuser;

  static String routeName = 'documen';
  static String routePath = 'documen';

  @override
  State<DocumenWidget> createState() => _DocumenWidgetState();
}

class _DocumenWidgetState extends State<DocumenWidget>
    with TickerProviderStateMixin {
  late DocumenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DocumenModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UserRecord>(
      stream: UserRecord.getDocument(widget!.docuser!),
      builder: (context, snapshot) {
        ...
        final documenUserRecord = snapshot.data!;
                                                          ...
                                                          itemBuilder: (context,
                                                            ...
                                                            return Container(
                                                              ...
                                                              child:
                                                                  DocumentWidget(
                                                                key: Key(
                                                                    'Keyy4p_${listViewIndex}_of_${listViewDocumentosRecordList.length}'),
                                                                documentos:
                                                                    listViewDocumentosRecord,
                                                              ),
                                                            );
                                                          },
                                                        );
