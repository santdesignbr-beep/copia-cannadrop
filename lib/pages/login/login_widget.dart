                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onPressed:
                                                                              ...
                                                                              if (valueOrDefault(currentUserDocument?.username, '') == null || valueOrDefault(currentUserDocument?.username, '') == '') {
                                                                                ...
                                                                                if (currentUserDisplayName == null || currentUserDisplayName == '') {
                                                                                  ...
                                                                                  if (valueOrDefault(currentUserDocument?.cpf, '') == null || valueOrDefault(currentUserDocument?.cpf, '') == '') {
                                                                                    context.pushNamedAuth(Cadastropaciente2Widget.routeName, context.mounted);

                                                                                    return;
                                                                                  } else {
                                                                                    if (valueOrDefault(currentUserDocument?.assinatura, '') == null || valueOrDefault(currentUserDocument?.assinatura, '') == '') {
                                                                                      context.pushNamedAuth(PoscadastropacienteWidget.routeName, context.mounted);

                                                                                      return;
                                                                                    } else {
                                                                                      if (valueOrDefault(currentUserDocument?.regiao, '') == null || valueOrDefault(currentUserDocument?.regiao, '') == '') {
