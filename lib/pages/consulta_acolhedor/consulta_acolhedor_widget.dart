...
import 'consulta_acolhedor_model.dart';
export 'consulta_acolhedor_model.dart';

class ConsultaAcolhedorWidget extends StatefulWidget {
  const ConsultaAcolhedorWidget({
    super.key,
    required this.consulta,
  });

  final DocumentReference? consulta;

  static String routeName = 'consulta_acolhedor';
  static String routePath = 'consulta_acolhedor';

  @override
  State<ConsultaAcolhedorWidget> createState() =>
      _ConsultaAcolhedorWidgetState();
}

class _ConsultaAcolhedorWidgetState extends State<ConsultaAcolhedorWidget>
    with TickerProviderStateMixin {
  late ConsultaAcolhedorModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConsultaAcolhedorModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ConsultaAcolhedorRecord>(
      stream: ConsultaAcolhedorRecord.getDocument(widget!.consulta!),
      builder: (context, snapshot) {
        ...
        final consultaAcolhedorConsultaAcolhedorRecord = snapshot.data!;
                                                          ...
                                                          padding:
                                                              EdgeInsetsDirectional
                                                                  .fromSTEB(
                                                                      ...
                                                                      4.0),
                                                          child: Text(
                                                            consultaAcolhedorConsultaAcolhedorRecord
                                                                .paciente,
