...
import 'configperfilpaciente_model.dart';
export 'configperfilpaciente_model.dart';

class ConfigperfilpacienteWidget extends StatefulWidget {
  const ConfigperfilpacienteWidget({super.key});

  static String routeName = 'configperfilpaciente';
  static String routePath = 'configperfilpaciente';

  @override
  State<ConfigperfilpacienteWidget> createState() =>
      _ConfigperfilpacienteWidgetState();
}

class _ConfigperfilpacienteWidgetState extends State<ConfigperfilpacienteWidget>
    with TickerProviderStateMixin {
  late ConfigperfilpacienteModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConfigperfilpacienteModel());
                                      ...
                                      builder: (context) => InkWell(
                                        ...
                                        onTap: () async {
                                          ...
                                          if (selectedMedia != null &&
                                              selectedMedia.every((m) =>
                                                  validateFileFormat(
                                                      ...
                                                      context))) {
                                            safeSetState(() => _model
                                                    .isDataUploading_imageconfigpaciente =
                                                true);
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_imageconfigpaciente =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                ...
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_imageconfigpaciente =
                                                    selectedUploadedFiles.first;
                                                _model.uploadedFileUrl_imageconfigpaciente =
                                                    downloadUrls.first;
                                              });
                                            } else {
                                              safeSetState(() {});
                                          ...
                                          await currentUserReference!
                                            ...
                                            photoUrl: _model
                                                .uploadedFileUrl_imageconfigpaciente,
                                          ));
                                        },
                                        child: Container(
                                          width: 80.0,
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                          EditarperfilpacienteWidget.routeName);
                                    },
                                    child: Row(
                                      mainAxisSize: MainAxisSize.max,
                                      mainAxisAlignment:
                                    ...
                                    child: AuthUserStreamWidget(
                                      builder: (context) => StreamBuilder<
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          List<RedeCannadropRecord>
                                              rowRedeCannadropRecordList =
                                              snapshot.data!;
                                          // Return an empty Container when the item does not exist.
                                          if (snapshot.data!.isEmpty) {
                                            return Container();
                                          }
                                          final rowRedeCannadropRecord =
                                              rowRedeCannadropRecordList
                                                      .isNotEmpty
                                                  ? rowRedeCannadropRecordList
                                                      .first
