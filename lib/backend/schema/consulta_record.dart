...
class ConsultaRecord extends FirestoreRecord {
  ...
  // "consulta_paciente" field.
  DocumentReference? _consultaPaciente;
  DocumentReference? get consultaPaciente => _consultaPaciente;
  bool hasConsultaPaciente() => _consultaPaciente != null;
  ...
  void _initializeFields() {
    ...
    _consultaPaciente = snapshotData['consulta_paciente'] as DocumentReference?;
...
Map<String, dynamic> createConsultaRecordData({
  ...
  DocumentReference? consultaPaciente,
  String? crm,
}) {
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'consulta_paciente': consultaPaciente,
      'CRM': crm,
    }.withoutNulls,
  );
...
class ConsultaRecordDocumentEquality implements Equality<ConsultaRecord> {
  ...
  bool equals(ConsultaRecord? e1, ConsultaRecord? e2) {
    ...
    return e1?.medico == e2?.medico &&
        ...
        e1?.consultaPaciente == e2?.consultaPaciente &&
        e1?.crm == e2?.crm;
  }
