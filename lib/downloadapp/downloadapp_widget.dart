...
import 'downloadapp_model.dart';
export 'downloadapp_model.dart';

class DownloadappWidget extends StatefulWidget {
  const DownloadappWidget({super.key});

  static String routeName = 'downloadapp';
  static String routePath = 'downloadapp';

  @override
  State<DownloadappWidget> createState() => _DownloadappWidgetState();
}
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    fit: BoxFit.scaleDown,
                                    image: Image.asset(
                                      'assets/images/LADING_PAGE_mobile.jpg',
                                    ).image,
                                  ),
                                ),
                              ),
