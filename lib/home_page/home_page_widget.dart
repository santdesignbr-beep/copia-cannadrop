            ...
            children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Image.asset(
                              'assets/images/emojione_flag-for-ceuta-and-melilla.png',
                              width: 24.0,
                              height: 24.0,
                              fit: BoxFit.cover,
                            ),
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: SelectionArea(
                                  child: Text(
                                'The best team of designers and programmers',
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                                      font: GoogleFonts.openSans(
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(24.0, 19.0, 24.0, 19.0),
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      crossAxisAlignment: CrossAxisAlignment.center,
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              width: 330.0,
                              child: Slider(
                                activeColor: Color(0xFFAA26FC),
                                inactiveColor: Color(0xFF9E9E9E),
                                min: 0.0,
                                max: 100.0,
                                value: _model.sliderValue ??= 26.0,
                                onChanged: (newValue) {
                                  safeSetState(
                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                          ...
                          child: Image.asset(
                            'assets/images/simple-icons_premierleague.png',
                          ),
                        ),
                        SelectionArea(
                            child: Text(
